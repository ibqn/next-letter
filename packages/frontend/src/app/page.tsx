    ...
    <main className="container flex flex-col gap-20 p-0 md:py-24">
      <div className="mx-auto flex flex-col rounded-lg border border-neutral-400/40 px-10 py-8 shadow-xl md:w-1/2">
        ...
        <p className="leading-7 not-first:mt-6">
          ...
          more! Whether you are a beginner or a seasoned developer, my compact newsletter has everything to keep you
      ...
      <Card className="mx-auto w-full max-w-lg">
        ...
        <CardContent>
          ...
          <p className="leading-7 not-first:mt-6">
            Elevate your coding skills with exclusive access to the latest tutorials, expert tips, coding challenges,
            and more! Whether you are a beginner or a seasoned developer, my compact newsletter has everything to keep
            you ahead. Join the community and transform your coding dreams into reality. Sign up for free today!
          </p>
          <SubscribeForm />
          <p className="mt-4">I respect your privacy. Unsubscribe at any time.</p>
        </CardContent>
